...
<body style="margin-top: 30px; background-color: #8B008B; background: url(t1.jpg) center center fixed">
    <div class="container" style="background-color: #91C8E4; width: 30%; padding: 20px; border-radius: 20px">
        ...
        <div class="main">
            <form method="post" action="ubah.php" enctype="multipart/form-data">
                ...
                <input class="tombol" type="submit" name="submit" style="background-color: #7CFC00" value="Simpan"/>
                </div>
            </form>
        </div>
    </div>
